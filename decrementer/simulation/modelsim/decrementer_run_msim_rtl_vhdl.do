...
vcom -93 -work work {C:/Users/franc/Documents/Quartus/decrementer/simulation/modelsim/decrementer.vht}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L rtl_work -L work -voptargs="+acc"  decrementer
