...
-- Equation(s):
-- \s~0_combout\ = ( \a[0]~input_o\ & ( \b[0]~input_o\ ) )
...
-- Equation(s):
-- \s~1_combout\ = ( \b[1]~input_o\ & ( \a[1]~input_o\ ) )
...
-- Equation(s):
-- \s~2_combout\ = ( \b[2]~input_o\ & ( \a[2]~input_o\ ) )
...
-- Equation(s):
-- \s~3_combout\ = ( \a[3]~input_o\ & ( \b[3]~input_o\ ) )
