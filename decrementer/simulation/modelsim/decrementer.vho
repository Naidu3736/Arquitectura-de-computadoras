...
SIGNAL \U0|U3|ALT_INV_cout~0_combout\ : std_logic;
...
\U0|U3|ALT_INV_cout~0_combout\ <= NOT \U0|U3|cout~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \U0|U3|ALT_INV_cout~0_combout\,
	devoe => ww_devoe,
	o => ww_c);
...
-- Equation(s):
-- \U0|U2|s~combout\ = ( \a[1]~input_o\ & ( !\a[2]~input_o\ ) ) # ( !\a[1]~input_o\ & ( !\a[2]~input_o\ $ (!\a[0]~input_o\) ) )
...
-- Equation(s):
-- \U0|U3|s~combout\ = ( \a[1]~input_o\ & ( !\a[3]~input_o\ ) ) # ( !\a[1]~input_o\ & ( !\a[3]~input_o\ $ (((!\a[0]~input_o\ & !\a[2]~input_o\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011110011110000111100001111000000111100111100001111000011110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \ALT_INV_a[0]~input_o\,
...
-- Equation(s):
-- \U0|U3|cout~0_combout\ = ( \a[1]~input_o\ ) # ( !\a[1]~input_o\ & ( ((\a[0]~input_o\) # (\a[2]~input_o\)) # (\a[3]~input_o\) ) )
