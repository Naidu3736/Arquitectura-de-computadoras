...
-- Equation(s):
-- \U1|s~combout\ = ( \a[1]~input_o\ & ( !\b[1]~input_o\ $ (((!\a[0]~input_o\ & \b[0]~input_o\))) ) ) # ( !\a[1]~input_o\ & ( !\b[1]~input_o\ $ (((!\b[0]~input_o\) # (\a[0]~input_o\))) ) )
...
-- Equation(s):
-- \U2|s~combout\ = ( \a[0]~input_o\ & ( \a[1]~input_o\ & ( !\a[2]~input_o\ $ (!\b[2]~input_o\) ) ) ) # ( !\a[0]~input_o\ & ( \a[1]~input_o\ & ( !\a[2]~input_o\ $ (!\b[2]~input_o\ $ (((\b[1]~input_o\ & \b[0]~input_o\)))) ) ) ) # ( \a[0]~input_o\ & ( 
-- !\a[1]~input_o\ & ( !\a[2]~input_o\ $ (!\b[1]~input_o\ $ (\b[2]~input_o\)) ) ) ) # ( !\a[0]~input_o\ & ( !\a[1]~input_o\ & ( !\a[2]~input_o\ $ (!\b[2]~input_o\ $ (((\b[0]~input_o\) # (\b[1]~input_o\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0110100110100101011010010110100101011010011010010101101001011010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \U1|cout~0_combout\ = ( \a[1]~input_o\ & ( (\b[1]~input_o\ & (!\a[0]~input_o\ & \b[0]~input_o\)) ) ) # ( !\a[1]~input_o\ & ( ((!\a[0]~input_o\ & \b[0]~input_o\)) # (\b[1]~input_o\) ) )
...
-- Equation(s):
-- \U3|s~combout\ = ( \a[2]~input_o\ & ( !\a[3]~input_o\ $ (!\b[3]~input_o\ $ (((\b[2]~input_o\ & \U1|cout~0_combout\)))) ) ) # ( !\a[2]~input_o\ & ( !\a[3]~input_o\ $ (!\b[3]~input_o\ $ (((\U1|cout~0_combout\) # (\b[2]~input_o\)))) ) )
...
-- Equation(s):
-- \U3|cout~0_combout\ = ( \U1|cout~0_combout\ & ( (!\a[3]~input_o\ & (((!\a[2]~input_o\) # (\b[3]~input_o\)) # (\b[2]~input_o\))) # (\a[3]~input_o\ & (\b[3]~input_o\ & ((!\a[2]~input_o\) # (\b[2]~input_o\)))) ) ) # ( !\U1|cout~0_combout\ & ( 
